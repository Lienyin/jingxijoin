...
public class SettleAccountsAdapter extends BaseQuickAdapter<OrderListEntity, BaseViewHolder> {

    private List<OrderListEntity> list;

    public SettleAccountsAdapter(@LayoutRes int layoutResId, @Nullable List<OrderListEntity> data) {
